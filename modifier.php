...
<html>
    ...
    <body>
        ...
        <form action = "#" method = "post">
            <p>Marque<br/><input type = "text" name = "marque" value = "<?php echo $voiture->get_marque() ?>" /></p>
            <p>Modèle<br/><input type = "text" name = "modele" value = "<?php echo $voiture->get_modele() ?>" /></p>
